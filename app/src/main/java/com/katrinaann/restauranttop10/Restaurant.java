...
public class Restaurant {
    ...
    public Restaurant(String name, String cuisineType, String location, String rating, int imageID, String about) {
        this.name = name;
